...
public class DataBase {
    ...
    public static Connection carConnection =null ;
    ...
    static {
        ...
        try {
            ...
            carConnection = DriverManager.getConnection(
                    GCON.URL,
                    GCON.CARUSERNAME,
                    GCON.CARPASSWORD);
            MAP.put(GCON.CARUSERNAME, carConnection);
    ...
    public static Connection getConnection() throws Exception {
        ...
        if (GCON.status == 0) {
            return MAP.get(GCON.CARUSERNAME) ;
        } else {
