...
<body>
<div class="box">
    <form autocomplete="off" id="form1" method="post" action="${pageContext.request.contextPath}/LoginServlet">
        <h2>登录</h2>
        <div class="links">
            <div class="ui radio checkbox">
                <input type="radio" name="admin" value="2" checked="checked">
                <label><h3><i class="user icon"></i>我是顾客</h3></label>
            </div>

            <div class="ui radio checkbox">
                <input type="radio" name="admin" value="3">
                <label><h3><i class="users icon"></i>我是供车商</h3></label>
            </div>
        ...
        <div class="inputBox">
            <input type="password" required="required" id="password" name="userpassword" autocomplete="current-password">
            <span>密码</span>
            <i></i>
        </div>
        <div class="links">
            <a href="common/forgetPassword.jsp?choice=1">忘记密码?</a>
            <a href="common/choiceinsertwho.jsp">注册</a>
        </div>
        <div>
