...
<head>
    ...
    <script >
        ...
        function fun4() {
            ...
            var year=idcard.substring(6,10)//取7-10位，不包含第6位包含第10位
            ...
            var url = "&carid=" + car +
                ...
                window.location.href = "/CustomerManage?op=1&" + url1 + url;
                ...
                <div class="ui three column grid">
                    ...
                    <div class="column" >
                        <div class="ui card" >
                            ...
                            <a class="ui orange right ribbon label" style="margin-left: -12px; margin-right: 20px" href="${pageContext.request.contextPath}/customerorder/carorder.jsp?op=2&cartype=<%=rtp.getCarType()%>">
                                ¥<%=rtp.getPrice()%>/天 →→ 点击租用 ←←
                            </a>
                            <% } else { %>
                    ...
                    <form class="ui form">
                        ...
                        <% ArrayList<Customer> info = searchonecustomer(customer);%>
                        <h4 class="ui dividing header">个人信息</h4>
                        <div class="fields">
                            <div class="seven wide field">
                                <label>姓名</label>
                                <input type="text" id="name" name="name" value="<%= info.get(0).getCustomerName()%>" readonly>
                            </div>
                            <div class="two wide field">
                                <label>性别</label>
                                <select class="ui fluid search dropdown" id="sex">
                                    <option value="<%=info.get(0).getCustomerGender()%>"><%=info.get(0).getCustomerGender()%></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="fields">
                            <div class="seven wide field">
                                <label>身份证号</label>
                                <input type="text" id="idcard" name="idcard" value="<%=info.get(0).getCustomerIDCard()%>" readonly>
                            </div>
                            <div class="seven wide field">
                                <label>手机号</label>
                                <input type="tel" id="phonenumber" name="phonenumber" value="<%=customer%>" readonly>
                            </div>
                        </div>
                    ...
                    <div class="ui right floated labeled button" tabindex="0">
                        ...
                        <div class="ui right button">
                            <i class="shopping icon"></i> <a href="${pageContext.request.contextPath}/CustomerManage?<%=request.getQueryString()%>">支付</a>
