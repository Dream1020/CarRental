...
<head>
  ...
  <script>
    ...
    function returnPage() {
      ...
      window.location.href = "InsertOneBusiness.jsp?choice=2&" + urlNew
    }
    ...
    function submintNewinfo() {
      ...
      window.location.href = "./InsertOneBusiness.jsp?choice=3" + url;
      return false;
    }
    ...
    function ensureButtonClicked() {
      ...
      window.location.href = "./InsertOneBusiness.jsp?choice=4&" + urlNew
    ...
    <div class="ui column grid">
      ...
      <div class="eleven wide column">
        ...
        <form class="ui form" onsubmit="return submintNewinfo(this)">
          <h2 class="ui dividing header">亲爱的租车商，请填写你的信息哦ヾ(•ω•`)o</h2>
        ...
        <%
          ...
          newbusiness.setBusinessid(request.getParameter("phonenumber"));
          newbusiness.setBusinesspassword(request.getParameter("password"));
          newbusiness.setBusinessidcard(request.getParameter("idcard"));
          newbusiness.setBusinesspassword(request.getParameter("password"));
          newbusiness.setBirthday(Date.valueOf(request.getParameter("birthday")));
          newbusiness.setGender(request.getParameter("gender"));
          Query.insertBusiness(newbusiness);
