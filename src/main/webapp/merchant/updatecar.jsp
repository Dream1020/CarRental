        ...
        <div class="ui column grid">
            <div class="four wide column">
                <div class="ui vertical steps"><%-- op= 3  完成修改基本信息，op<3,修改基本信息  op==6  完成修改照片  ，op>6,修改照片--%>
                    <div class="<%=(op <3) ? "active step ":(op==3)?"completed step":"step"%>" onclick="window.location.href='/merchant/updatecar.jsp?op=1'">
                    ...
                    <div class="<%=(op >6) ? "active step ":(op==6)?"completed step":"step"%>" onclick="window.location.href='/merchant/updatecar.jsp?op=7'">
                        <i class="check circle icon"></i>
                        <div class="content">
            ...
            <div class="eleven wide column">
                ...
                <div class="ui middle aligned center aligned grid">
                    <div class="column">
                        ...
                        <br>
                        <br>
                        <h1 class="ui red header">你账户下没有车辆哦，我们可以试着将空闲车辆租出来的!!!</h1>
                    </div>
                </div>
                <%}%>
                <%} else if (op==2) {%>
                ...
                <a class="ui button" href="carretal.jsp">确定</a>
...
<script>
    ...
    function getCarInfo() {
        ...
        window.location.href = "/merchant/updatecar.jsp?op=1&carNumber=" + selectedCarNumber;
    }
    function getCarInfo1() {
        var selectedCarNumber = document.getElementById("carNumber1").value;
        window.location.href = "/merchant/updatecar.jsp?op=7&carNumber=" + selectedCarNumber;
    }
