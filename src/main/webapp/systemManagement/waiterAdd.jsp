...
<%@ page import="static com.example.car_rental.tool.Query.getWaiter" %>
...
<head>
    ...
    <script>
        ...
        function returnm() {
            window.location.href="waiterAdd.jsp";
        }
                ...
                <form class="ui form" onsubmit="return sub1(this)">
                    ...
                    <div class="two fields">
                        <div class="  field">
                            ...
                            <input type="date" value="<%=(waiter==null)?"":waiter.getWaiterJoinDate()%>" id="waiterJoinDate"/>
